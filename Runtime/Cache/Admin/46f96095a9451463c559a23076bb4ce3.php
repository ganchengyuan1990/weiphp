...
<head>
    ...
    <link href="/php/weiphp3/Public/favicon.ico" type="image/x-icon" rel="shortcut icon">
    <link rel="stylesheet" type="text/css" href="/php/weiphp3/Public/Admin/css/base.css?v=<?php echo SITE_VERSION;?>" media="all">
    <link rel="stylesheet" type="text/css" href="/php/weiphp3/Public/Admin/css/common.css?v=<?php echo SITE_VERSION;?>" media="all">
    <link rel="stylesheet" type="text/css" href="/php/weiphp3/Public/Admin/css/module.css?v=<?php echo SITE_VERSION;?>" />
    <link rel="stylesheet" type="text/css" href="/php/weiphp3/Public/Admin/css/style.css?v=<?php echo SITE_VERSION;?>" media="all">
    <link rel="stylesheet" type="text/css" href="/php/weiphp3/Public/Admin/css/store.css?v=<?php echo SITE_VERSION;?>" media="all">
	<link rel="stylesheet" type="text/css" href="/php/weiphp3/Public/Admin/css/<?php echo (C("COLOR_STYLE")); ?>.css?v=<?php echo SITE_VERSION;?>" media="all">
     <!--[if lt IE 9]>
    ...
    <script type="text/javascript" src="/php/weiphp3/Public/Admin/js/jquery.mousewheel.js?v=<?php echo SITE_VERSION;?>"></script>
    <!--<![endif]-->
...
<!--         <img style="height:49px;" src="/weiphp3.0/Public/Home/images/logo.png"> -->
							...
							<?php case "picture_union": ?><div class="controls">
								...
								<script type="text/javascript">
									...
									function uploadPicture<?php echo ($o_key); ?>(file, data){
										...
										if(data.status){
											...
											$("#cover_id_<?php echo ($o_key); ?>").parent().find('.upload-img-box').append(
												'<div class="upload-pre-item" val="' + data.id + '"><img src="/php/weiphp3' + src + '" ondblclick="removePicture<?php echo ($o_key); ?>(this)"/></div>'
											);
									...
									function setPictureIds<?php echo ($o_key); ?>(){
										var ids = [];
										$("#cover_id_<?php echo ($o_key); ?>").parent().find('.upload-img-box').find('.upload-pre-item2').each(function(){
												...
												<?php case "picture_union": ?><div class="controls">
													...
													<script type="text/javascript">
														...
														function uploadPicture<?php echo ($o_tab_key); ?>(file, data){
															...
															if(data.status){
																...
																$("#cover_id_<?php echo ($o_tab_key); ?>").parent().find('.upload-img-box').append(
																	'<div class="upload-pre-item" val="' + data.id + '"><img src="/php/weiphp3' + src + '" ondblclick="removePicture<?php echo ($o_tab_key); ?>(this)"/></div>'
																);
														...
														function setPictureIds<?php echo ($o_tab_key); ?>(){
															var ids = [];
															$("#cover_id_<?php echo ($o_tab_key); ?>").parent().find('.upload-img-box').find('.upload-pre-item2').each(function(){
																ids.push($(this).attr('val'));
															});
															if(ids.length > 0)
    ...
    <!-- /内容区 -->
    <script type="text/javascript">
	var  IMG_PATH = "/php/weiphp3/Public/Admin/images";
    ...
    <script type="text/javascript" src="/php/weiphp3/Public/static/think.js?v=<?php echo SITE_VERSION;?>"></script>
    <script type="text/javascript" src="/php/weiphp3/Public/Admin/js/common.js?v=<?php echo SITE_VERSION;?>"></script>
    <script type="text/javascript">
        +function(){
