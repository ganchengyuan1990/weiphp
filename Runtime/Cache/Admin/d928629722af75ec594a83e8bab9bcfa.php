...
function showMsg(msg){
	$('#data-table').hide();
    $('#showInfomation').html('<div id="listInfo"><div class="content"><h3 class="center"><img src="/php/weiphp3/Public/Admin/images/loading_icon.gif" class="mr10"/>'+msg+'...</h3></div></div>');
}
