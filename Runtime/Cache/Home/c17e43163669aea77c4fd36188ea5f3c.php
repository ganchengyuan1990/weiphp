        ...
        <form id="form" action="<?php echo ($post_url); ?>" method="post" class="form-horizontal form-center">
        	<ul id="tab" class="tab-pane in">
            	 <li class="form-item cf">
                    ...
                    <div class="controls">
                      <input type="text" class="text input-large" name="prize_title" value="<?php echo ($data["prize_title"]); ?>">
                    </div>
                  </li> 
                  <li class="form-item cf">
                    <label class="item-label"><span class="need_flag">*</span>奖品名称<span class="check-tips"></span></label>
                    <div class="controls">
                      <input type="text" class="text input-large" name="prize_name" value="<?php echo ($data["prize_name"]); ?>">
                    </div>
                  </li>  
                  <li class="form-item cf">
                    ...
                    <div class="controls">
                      ...
                      <textarea class="text input-large" name="prize_conditions" ><?php echo ($data["prize_conditions"]); ?></textarea>
                      </label>
                    </div>
                  </li>   
                  <li class="form-item cf">
                    <label class="item-label"><span class="need_flag">*</span>奖品个数<span class="check-tips"></span></label>
                    <div class="controls">
                      <input type="number" class="text input-large" name="prize_count" value="<?php echo ($data["prize_count"]); ?>">
                    </div>
                  </li>  
                  <li class="form-item cf">
                  		<label class="item-label"><span class="need_flag">*</span>奖品图片<span class="check-tips"></span></label>
                		<div class="controls uploadrow2" data-max="1" title="点击修改图片" rel="prize_image">
                            <input type="file" id="upload_picture_prize_image">
                            <input type="hidden" name="prize_image" id="cover_id_prize_image" value="<?php echo ($data["prize_image"]); ?>"/>
                            <div class="upload-img-box">
                              <?php if(!empty($data[prize_image])): ?><div class="upload-pre-item2"><img width="100" height="100" src="<?php echo (get_cover_url($data["prize_image"])); ?>"/></div>
                  ...
                  <li class="form-item cf toggle-prize_type">
              			...
              			<div class="controls">
                			<?php $_result=parse_field_attr($fields['prize_type']['extra']);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="check-item">
								  ...
								  <?php if(($data[prize_type]) == $key): ?>checked="checked"<?php endif; ?> />
                   ...
                   <li class="form-item cf">
                    ...
                    <div class="controls">
                      <label class="textarea input-large">
                      <textarea class="text input-large" name="use_content" ><?php echo ($data["use_content"]); ?></textarea>
                      </label>
                    </div>
                  </li>  
                   <li class="form-item cf">
                    ...
                    <div class="controls">
                      <label class="textarea input-large">
                      <textarea class="text input-large" name="fail_content" ><?php echo ($data["fail_content"]); ?></textarea>
                      </label>
                    </div>
                  </li>  
...
(function(){
  ...
  <script type="text/javascript" src="/php/weiphp3/Public/static/datetimepicker/js/bootstrap-datetimepicker.js"></script> 
