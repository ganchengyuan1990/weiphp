        ...
        <div class="table-striped">
          <table cellspacing="1">
            ...
            <tbody>
              ...
              <tr>
                <td colspan="2">公众号ID</td>
                <td><?php echo ($info["id"]); ?></td>
              </tr>
              <tr>
                <td colspan="2">公众号类型</td>
                <td><?php echo ($info["type"]); ?></td>
              </tr>
              <tr>
                <td colspan="2">公众号名</td>
                <td><?php echo ($info["public_name"]); ?></td>
              </tr>
              <tr>
                <td colspan="2">微信号</td>
              ...
              <tr>
                <td colspan="2">原始ID</td>
                <td><?php echo ($info["public_id"]); ?></td>
              </tr>
              <tr>
                <td colspan="2">AppID</td>
                <td><?php echo ($info["appid"]); ?></td>
              </tr>
              <tr>
                <td colspan="2">Secret</td>
                <td><?php echo ($info["secret"]); ?></td>
              </tr>
              <tr>
                <td colspan="2">EncodingAESKey</td>
                <td><?php echo ($info["encodingaeskey"]); ?></td>
              </tr>
              <tr>
                <td colspan="2">管理员ID</td>
              ...
              <tr>
                <td colspan="2">微信后台配置的地址：</td>
                <td><?php echo U('home/weixin/index',array('id'=>$info[id]));?></td>
              </tr>
              <tr>
                <td colspan="2">微信后台配置的Token(令牌)：</td>
                <td><?php echo SYSTEM_TOKEN;?></td>
              </tr>
              <tr>
                <td colspan="2">&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td colspan="3" align="center">各插件配置参数</td>
              </tr>
              
   
              <?php foreach($info['addon_config'] as $k=>$vo) { $count = count($vo); foreach($vo as $kkk=>$vvv) { $key = $kkk; $val=$vvv;unset($vo[$kkk]);break;} ?>
              <tr>
                <td rowspan="<?php echo ($count); ?>"><?php echo ($k); ?></td>
                <td><?php echo ($key); ?></td>
                <td><?php echo ($val); ?></td>
              </tr>
              <?php foreach($vo as $kk=>$vv) { ?>
              <tr>
                <td><?php echo ($kk); ?></td>
                <td><?php echo ($vv); ?></td>
              </tr>
