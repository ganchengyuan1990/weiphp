...
<div id="content">
    <div id="weiba" data-title="论坛" class="panel" data-selected="true"  data-menu="msgmenu" style="padding:0;">
        <header>
            ...
            <h1>
            	<?php switch($type){ case 'myWeiba':echo '我关注的版块';break; case 'myFollowing':echo '我关注的版块帖子';break; case 'myPost':; case 'myReply':; case 'myFavorite':echo '我的话题';break; case 'myFavoriteEvent':; case 'myJoinEvent':echo '我的活动';break;; case 'myDownload':echo '我的下载';break;; default:echo '我'; } ?>
    ...
    <div class="weiba_forumlist" style="margin-top:0">
      ...
      <div class="navlist" style="margin-top:10px">
        <ul>
            ...
            <li><a href="<?php echo addons_url('Weiba://Wap/my', array('type'=>'myPost'));?>">我的话题<em class="msg"  id="my_topic_msg"></em></a></li>
            <!--
