...
<body>
<div class="jump_tips">
    <?php if(isset($message)): ?><header>
            <img src="/php/weiphp3/Public/Home/images/mobile_jump_success_face.png"/>
            <p class="success"><?php echo($message); ?></p>
        </header>
    <?php else: ?>
        <header>
            <img src="/php/weiphp3/Public/Home/images/mobile_jump_err_face.png"/>
    ...
    <p class="jump" >
    	<a id="href" href="<?php echo($jumpUrl); ?>">页面即将跳转跳转</a>
    </p>
</div>
