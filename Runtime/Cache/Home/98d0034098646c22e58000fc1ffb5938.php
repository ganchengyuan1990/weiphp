      	 ...
      	 <div class="fl" style="width:600px;">
            <div class="controls">
                <label class="item-label"><span class="need_flag">*</span>
                       发送人<span class="check-tips"></span>
                </label>
            ...
            <div class="controls">
                <label class="item-label"><span class="need_flag">*</span>
                       接收人<span class="check-tips"></span>
                </label>
                <input type="text" name="receive_name" class="text input-large" />
            </div>
            <div class="form-item">
                <label class="item-label"><span class="need_flag">*</span>
                       祝福语[<a style="color:red" href="javascript:;" id="chooseWishContentBtn">从祝福语库中选择</a>]<span class="check-tips"></span>
                </label>
                <div class="controls">
            ...
            <div class="form-item">
                <label class="item-label"><span class="need_flag">*</span>
                       <a class="border-btn" href="javascript:;" id="chooseTemplateBtn">模板选择</a><span class="check-tips"></span>
...
//选择祝福语
var chooseWishContentUrl = "<?php echo addons_url('WishCard://WishCardContent/content_list');?>";
var addWishContentUrl = "<?php echo addons_url('WishCard://WishCardContent/add?model=wish_card_content');?>";
...
//选择模板
var templateDataUrl = "<?php echo addons_url('WishCard://WishCard/getTemplist');?>";
