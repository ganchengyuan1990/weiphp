...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
     ...
     <h5>快捷交易</h5>
     <a class="tile tile_themed" onClick="$.WeiPHP.openSubmitDialog('会员消费','<?php echo addons_url('Card://Member/do_buy?model='.$model['id'],array('id'=>$data['id']));?>',600,600)" href="javascript:;">
     <i class="i_usd"></i>
     <div class="div_info">
     <strong>消费</strong>
     </div>
     </a>
     <a class="tile tile_themed" onClick="$.WeiPHP.openSubmitDialog('会员充值','<?php echo addons_url('Card://Member/do_recharge?model='.$model['id'],array('id'=>$data['id']));?>',600,400)" href="javascript:;">
     <i class="i_yen"></i>
     <div class="div_info">
     <strong>充值</strong>
     </div>
     </a>
     <a class="tile tile_themed" onClick="$.WeiPHP.openSubmitDialog('手动修改积分','<?php echo addons_url('Card://Member/update_score?model='.$model['id'],array('id'=>$data['id']));?>',600,400)" href="javascript:;">
     <i class="i_money"></i>
     <div class="div_info">
     <strong>手动修改积分</strong>
     </div>
     </a>
     <a class="tile tile_themed" onClick="$.WeiPHP.openSubmitDialog('券类核销','<?php echo U('duihuang?model='.$model['id']);?>',600,400)" href="javascript:;">
     <i class="i_gift"></i>
     <div class="div_info">
     <strong>券类核销</strong>
     </div>
      ...
      <div class="tab-content has-weixinpreivew"> 
     <h5>交易统计</h5>
     <a class="tile tile_themed" href="<?php echo addons_url('Card://MemberTransition/buy_tongji');?>&mdm=<?php echo ($_GET['mdm']); ?>">
     <i class="i_chart"></i>
     <div class="div_info">
     <strong>消费统计</strong>
     </div>
     </a>
     <a class="tile tile_themed"  href="<?php echo addons_url('Card://MemberTransition/score_tongji');?>&mdm=<?php echo ($_GET['mdm']); ?>">
     <i class="i_chart"></i>
     <div class="div_info">
     <strong>积分统计</strong>
     </div>
     ...
     <h5>交易明细查询</h5>
     <a class="tile tile_themed" href="<?php echo addons_url('Card://MemberTransition/buy_lists');?>&mdm=<?php echo ($_GET['mdm']); ?>">
     <i class="i_search"></i>
     <div class="div_info">
     <strong>消费查询</strong>
     </div>
     </a>
     <a class="tile tile_themed" href="<?php echo addons_url('Card://MemberTransition/recharge_lists');?>&mdm=<?php echo ($_GET['mdm']); ?>">
     <i class="i_search"></i>
     <div class="div_info">
     <strong>充值查询</strong>
     </div>
     </a>
     <a class="tile tile_themed"  href="<?php echo addons_url('Card://MemberTransition/score_lists');?>&mdm=<?php echo ($_GET['mdm']); ?>">
     <i class="i_search"></i>
     <div class="div_info">
     <strong>积分查询</strong>
     </div>
...
<link type="text/css" rel="stylesheet" href="/php/weiphp3/Public/static/colorpicker/colpick.css?v=<?php echo SITE_VERSION;?>"/>
<script type="text/javascript" src="/php/weiphp3/Public/static/colorpicker/colpick.js?v=<?php echo SITE_VERSION;?>" charset="UTF-8"></script> 
