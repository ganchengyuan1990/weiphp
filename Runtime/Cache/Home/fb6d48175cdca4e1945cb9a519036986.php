         	...
         	<div class="form-item">
                <div class="controls">
                    <label class="item-label">
                           祝福语类别<span class="check-tips"></span>
                    </label>
                    <select name="content_cate_id">
                        <?php if(is_array($content_cate)): $i = 0; $__LIST__ = $content_cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["content_cate_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
            </div>
            <div class="form-item">
                <label class="item-label">
                       祝福语<span class="check-tips"></span>
                </label>
                <div class="controls">
