    ...
    <section id="contents"> 
      <div class="table-bar">
        ...
        <div class="search-form fr cf">
          <input type="text" placeholder="请输入优惠券标题搜索" value="<?php echo I('title');?>" class="search-input" name="title">
          ...
          <table cellspacing="1">
            ...
            <tbody>
              <?php if(is_array($list_data)): $i = 0; $__LIST__ = $list_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td type="nickname"><?php echo ($vo["title"]); ?></td>
                   <td type=""><?php echo ($vo["num"]); ?></td>
                   <td type=""><?php echo ($vo["collect_count"]); ?></td>
                   <td type=""><?php echo ($vo["use_count"]); ?></td>
                   <td type=""><?php echo (time_format($vo["start_time"])); ?></td>
                   <td type=""><?php echo (time_format($vo["end_time"])); ?></td>
