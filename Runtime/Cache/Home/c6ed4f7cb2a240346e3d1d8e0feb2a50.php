...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
      <p class="normal_tips"><b class="fa fa-info-circle"></b>会员卡链接:<a target="_blank" href="<?php echo U( 'preview' );?>">预览</a>,<a id="copyLink" data-clipboard-text="<?php echo addons_url('Card://Wap/index',array('publicid'=>$public_info['id']));?>">复制链接</a><script type="application/javascript">$.WeiPHP.initCopyBtn("copyLink");</script>
      </p>
        ...
        <form action="<?php echo U('config');?>" class="form-horizontal" method="post">
            <?php if(empty($custom_config)): ?><div class="field_group">
                        ...
                        <div class="card_preview fl" style="margin:15px 40px;">
                        	<div id="cardLogo" style="display:none"><img src="/php/weiphp3/Public/Home/images/default.png"></div>
                                ...
                                <?php if($o_key=='background'): ?><!-- 自定义上传背景 -->
                                 <div id="customBackground">
                                    ...
                                    <div  class="controls uploadrow2"  data-max="1" title="点击修改图片" rel="bg">
                                          ...
                                          <input type="hidden" name="config[bg]" id="cover_id_bg" value="<?php echo ($config['bg_id']); ?>"/>
                                 ...
                                 <div id="customBackBackground"
                                    ...
                                    <div class="controls uploadrow2"  data-max="1" title="点击修改图片" rel="backbg">
                                          ...
                                          <input type="hidden" name="config[backbg]" id="cover_id_backbg" value="<?php echo ($config['backbg_id']); ?>"/>
                                          <div class="upload-img-box">
