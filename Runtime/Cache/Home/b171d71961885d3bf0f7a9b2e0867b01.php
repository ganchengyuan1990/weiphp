...
<div class="login_header">
    ...
    <div class="log_wrap">
        <a href="/" title="WeiPHP"><img class="logo" src="/php/weiphp3/Public/Home/images/logo.png"/></a>
    </div>
    	...
    	<div class="top_content">
        	<div class="log_wrap">
            	<div class="top_content_r">
                	<img src="/php/weiphp3/Public/Home/images/about/img/banner_pic.png?20150723"/>
                </div>
            	<section class="login_box">
                  <form class="login-form" action="/php/weiphp3/index.php?s=/Home/User/login/from/1.html" method="post">
