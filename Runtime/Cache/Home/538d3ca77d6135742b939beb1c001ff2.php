    ...
    <section id="contents"> 
      <div class="table-bar">
        ...
        <div class="search-form fr cf">
          <input type="text" placeholder="请输入活动名称搜索" value="<?php echo I('title');?>" class="search-input" name="title">
            ...
            <tbody>
              <?php if(is_array($list_data)): $i = 0; $__LIST__ = $list_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td type="title"><?php echo ($vo["title"]); ?></td>
                   <td type="game_type">
                   <?php if($vo['game_type']==1){ echo '刮刮乐'; }else if($vo['game_type']==2){ echo '大转盘'; }else if($vo['game_type']==3){ echo '砸金蛋'; }else if($vo['game_type']==4){ echo '九宫格'; } ?>
                   </td>
                   <td type="start_time"><?php echo (time_format($vo["start_time"])); ?></td>
                   <td type="end_time"><?php echo (time_format($vo["end_time"])); ?></td>
                   <td type="status"><?php echo ($vo["status"]); ?></td>
                    <td type="attend_num"><?php echo ($vo["attend_num"]); ?></td>
