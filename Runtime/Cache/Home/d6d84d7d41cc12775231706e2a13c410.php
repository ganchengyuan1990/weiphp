...
<body>
	<div class="container body">
    	<div class="card">
            ...
            <?php if($has_subscribe == 1): ?><a class="get_btn" href="<?php echo addons_url('Card://Wap/get_success');?>&status=2">点击成为慢城居民</a>
            <?php else: ?>
            	<a class="get_btn" href="javascript:;" onClick="$.WeiPHP.showSubscribeTips({'title':'{$public_info.public_name}','qrcode': '<?php echo ($qrcode); ?>'});">点击成为慢城居民</a><?php endif; ?>
        </div>
