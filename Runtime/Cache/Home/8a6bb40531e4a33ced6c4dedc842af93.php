	...
	<div id="container" class="container body">
        ...
        <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="single_item m_15 p_10 toggle_list_open">
                ...
                <div class="content" style="margin-top:0">
                    ...
                    <p>状态: <?php if($vo['enable'] == true): ?><img style="vertical-align:-6px" src="/php/weiphp3/Public/Home/images/yes.png" height="20"/>可用<?php else: ?><img style="vertical-align:-6px" src="/php/weiphp3/Public/Home/images/error.png" height="20"/>不可用<?php endif; ?></p>
                </div>
            </li><?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>   	
        <?php if(empty($lists)): ?><div class="empty_default">
            	<br/><br/>
            	<p><img src="/php/weiphp3/Public/Home/images/empty_content.png"/><br/>没有任何特权~</p>
            </div><?php endif; ?>
