        ...
        <div class="table-striped">
          <table cellspacing="1">
            ...
            <?php if(is_array($list_data)): $i = 0; $__LIST__ = $list_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                ...
                <a data-clipboard-text="<?php echo addons_url('Reserve://Wap/index',array('reserve_id'=>$data[id],'publicid'=>$public_info[id]));?>" class="list_copy_link" id="copyLink_<?php echo ($data["id"]); ?>">复制链接</a></td>
