      ...
      <div class="tab-content"> 
        ...
        <form class="form-horizontal form-center" method="post" action="<?php echo ($post_url); ?>" id="form">
          <div class="form-item cf toggle-name">
            <label class="item-label"> <span class="need_flag">*</span> 店名 <span class="check-tips"> </span></label>
            <div class="controls">
          ...
          <div class="form-item cf toggle-phone">
            ...
            <div class="controls">
              <input type="text" value="<?php echo ($data["phone"]); ?>" name="phone" class="text input-large">
            </div>
          </div>    
          <div class="form-item cf">
            <label class="item-label"> 营业时间 <span class="check-tips"> </span></label>
            <div class="controls">
              <input type="text" value="<?php echo ($data["open_time"]); ?>" name="open_time" class="text input-large">
            </div>
          </div>                   
          <div class="form-item cf toggle-address">
            ...
            <div class="controls">
              <input type="text" value="<?php echo ($data["address"]); ?>" name="address" id="address" class="text input-large">
            </div>
          </div>
          <div class="form-item cf toggle-gps">
            <label class="item-label"> 地图位置 <span class="check-tips"> （请点击地图，然后拖动图标到你的位置上） </span></label>
            <div class="controls">
              <input type="hidden" value="<?php echo ($data["gps"]); ?>" name="gps" id="gps" class="text input-large">
...
(function(){
  ...
  <script type="text/javascript" src="/php/weiphp3/Public/static/bdMap.js?v=<?php echo SITE_VERSION;?>"></script> 
  <script type="text/javascript">
function initMap(){
	var _addr = '';
	_addr = $('#address').val();
	ShowMap("map",{city:'深圳',addr:_addr,title:'',lawfirm:'',tel:'',mapx:'<?php echo ($data["gps"]); ?>',pic:'',ismove:'1',piobj:'gps'});
}
$(function(){
    showTab();
	initMap();
