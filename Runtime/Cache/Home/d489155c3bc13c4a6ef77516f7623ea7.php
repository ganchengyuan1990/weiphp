...
<div class="login_header">
    <div class="small_wrap">
        <a href="/" title="乐摇"><img class="logo" src="/php/weiphp3/Public/Home/images/logo.png"/></a>
        <div class="nav_r">
...
<section class="reg_box small_wrap about_wrap">
    ...
    <div class="about_content">
        ...
        <P>
            ...
            <br/>
            <img src="/php/weiphp3/Public/Home/images/about/help/ly_lead_001.png"/>
        </P>
        <p>
        ...
        <P>
        	请按照图示填写正确的信息：
            <br/>
            <img src="/php/weiphp3/Public/Home/images/about/help/ly_lead_0021.png"/>
        </P>
        <p>
        ...
        <P>
        	请按照图示填写正确的公众号信息：
            <br/>
            <img src="/php/weiphp3/Public/Home/images/about/help/ly_lead_002.png"/>
        </P>
        ...
        <P>
            ...
            <img src="/php/weiphp3/Public/Home/images/about/help/ly_lead_003.png"/>
            配置JS接口安全域名，在公众号设置-功能配置里面配置，配置JS安全域名如下图<br/>
            <img src="/php/weiphp3/Public/Home/images/about/help/ly_lead_004.png"/>
        </P>
        <p>
        ...
        <P>
            ...
            <img src="/php/weiphp3/Public/Home/images/about/help/ly_lead_0022.png"/>
        </P>
        <P>
