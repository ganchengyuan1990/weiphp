...
<div id="main-container" class="container" style="position:relative">
 ...
 <div class="wrap" style="clear:both; margin:30px auto;">
	<section class="tab-content" id="contents">
      ...
      <h3 style=" float:left;margin-bottom:15px;"><img style="vertical-align:middle; height:30px" src="/php/weiphp3/Public/Home/images/weixin.png"/> 我创建的公众号</h3>
...
<a href="<?php echo U('Home/Public/check_res',array('id'=>$data[id]));?>" target="_self">自动检测</a>&nbsp;&nbsp;&nbsp;                
        ...
        <?php else: ?>
        <div style="padding:100px; text-align:center;"><img style="vertical-align:middle;" src="/php/weiphp3/Public/Home/images/weixin.png"/>  你还没有创建公众号</div><?php endif; ?>
      </div>
      
      <!--
      	<a class="btn" href="<?php echo U('add');?>">+新增公众号</a>
      -->
      <?php if(!empty($list_data[0])): ?><h3 style="margin:15px 0;"><img style="vertical-align:middle; height:25px" src="/php/weiphp3/Public/Home/images/user_icon.png"/> 我加入的公众号</h3>
      <div class="data-table" style="margin:0">
        <div class="table-striped">
          <table cellspacing="1">
            ...
            <?php if(is_array($list_data[0])): $i = 0; $__LIST__ = $list_data[0];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td><?php echo ($data["token"]); ?></td>
                <td><?php echo ($data["count"]); ?></td>
                <td><a href="<?php echo U('Home/Index/main',array('public_id'=>$data[id]));?>" target="_self">进入管理</a></td>
              </tr><?php endforeach; endif; else: echo "" ;endif; ?>
            </tbody>
          </table>
        </div><?php endif; ?>
