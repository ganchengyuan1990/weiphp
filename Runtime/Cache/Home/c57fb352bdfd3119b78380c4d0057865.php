...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
     ...
     <h5>赠送券管理</h5>
     <a class="tile tile_themed" href="<?php echo addons_url('Coupon://Coupon/lists');?>&mdm=<?php echo ($_GET['mdm']); ?>">
     <i class="i_ticket"></i>
     <div class="div_info">
     <strong>优惠券</strong>
     </div>
     ...
     <a class="tile tile_themed" href="<?php echo addons_url('ShopCoupon://ShopCoupon/lists');?>&mdm=<?php echo ($_GET['mdm']); ?>">
     <i class="i_ticket"></i>
     <div class="div_info">
     <strong>代金券</strong>
     </div>
      ...
      <div class="tab-content has-weixinpreivew"> 
     <h5>客户营销</h5>
     <a class="tile tile_themed" href="<?php echo addons_url('Card://Reward/lists');?>&mdm=<?php echo ($_GET['mdm']); ?>">
     <i class="i_card"></i>
     <div class="div_info">
     <strong>开卡即送</strong>
     </div>
     </a>
     <a class="tile tile_themed" href="<?php echo addons_url('SingIn://SingIn/lists');?>&mdm=<?php echo ($_GET['mdm']); ?>">
     <i class="i_share"></i>
     <div class="div_info">
     <strong>签到分享</strong>
     </div>
     </a>
     <a class="tile tile_themed" href="<?php echo addons_url('Card://Score/lists');?>&mdm=<?php echo ($_GET['mdm']); ?>">
     <i class="i_empty"></i>
     <div class="div_info">
     <strong>积分兑换</strong>
     </div>
     </a>
     <a class="tile tile_themed" href="<?php echo addons_url('Card://Recharge/lists');?>&mdm=<?php echo ($_GET['mdm']); ?>">
     <i class="i_chongzhi"></i>
     <div class="div_info">
     <strong>充值赠送</strong>
     </div>
     </a>
     <a class="tile tile_themed" href="<?php echo addons_url('ShopReward://ShopReward/lists');?>&mdm=<?php echo ($_GET['mdm']); ?>">
     ...
     <h5>客户关怀</h5>
     <a class="tile tile_themed" href="<?php echo addons_url('Card://Custom/lists');?>&mdm=<?php echo ($_GET['mdm']); ?>">
     <i class="i_heart"></i>
     <div class="div_info">
     <strong>客户关怀</strong>
     </div>
