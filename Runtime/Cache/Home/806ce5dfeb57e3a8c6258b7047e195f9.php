        ...
        <div class="table-striped">
          <table cellspacing="1">
            ...
            <tbody>
              ...
              <tr>
                <td colspan="2">版权</td>
                <td><?php echo ($info["copy_right"]); ?></td>
              </tr>
              <tr>
                <td colspan="2">统计代码</td>
                <td><?php echo ($info["tongji_code"]); ?></td>
              </tr>
              <tr>
                <td colspan="2">所属用户组</td>
                <td><?php echo implode(', ', getSubByKey($info['groups'],'title'));?></td>
              </tr>
              <tr>
                <td colspan="2">是否是系统管理员</td>
                <td><?php echo ($info["is_root"]); ?></td>
              </tr>
