...
<div id="content" interface="favorite">
    <div id="user-weibo-list" data-title="<?php echo ($datatitle); ?>" date-selected="true" data-footer="none" data-rememberScroll="true">
        <header>
            <div id="header-buttons">
    ...
    <div id="i_info">
        <div id="i_info_top">
                <div id="i_info_top_ava">
                    <!-- 头像 -->
                    <img src="<?php echo ($profile["headimgurl"]); ?>" width="80" height="80" >
                </div>
                <div id="i_info_top_box">
                    <div class="name_intro">
                    	<div class="u_info">
                        	<span class="name"><strong><?php echo ($profile["nickname"]); ?></strong><!--<img  src="<?php echo APPS_URL;?>/w3g/_static/img/sys/ic_teacher.png"/>--></span><br/>
                            <span class="intro">
                            	<?php if($profile['remark']): echo ($profile["remark"]); ?>
                                <?php else: ?>
                                 一句话介绍一下自己让大家更了解你<?php endif; ?>
                            </span>
                        </div>
                        <div class="u_zan">
                        	<b><?php echo ($praiseCount); ?></b><br/>
                            收到的赞
                        </div>
                    </div>
    ...
    <div class="bklist">
      ...
      <div class="weiba_postlist">
            ...
            <?php if(is_array($post_list["list_data"])): $i = 0; $__LIST__ = $post_list["list_data"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li onclick="javascript:window.open('<?php echo addons_url('Weiba://Wap/postDetail',array('post_id'=>$vo['id']));?>','_self')">
                ...
                <div class="info clearfix">
                    <div class="left">
                         ...
                         <?php echo ($vo["user"]["nickname"]); ?></a></span>
                    </div>
                    <div class="right">
                    <?php if($vo['read_count']>0){ ?><span class="llnum"><?php echo ($vo["read_count"]); ?></span><?php }if($vo['reply_count']>0){ ?><span class="plnum"><?php echo ($vo["reply_count"]); ?></span><?php } ?>
                    </div>
                </div>
          ...
          <div id="pager_box">
            ...
            <a href="<?php echo addons_url('Weiba://Wap/profile',array('weiba_id'=>$weiba_detail['id'],'type'=>$type,'page'=>$post_list['nowPage']-1));?>" id="prev" class="pure-button pager_child pager_p_n pure-button-primary">上一页</a>
            <?php endif; ?>
            <?php if($post_list['nowPage']<$post_list['totalPages']): ?>
            <a href="<?php echo addons_url('Weiba://Wap/profile',array('weiba_id'=>$weiba_detail['id'],'type'=>$type,'page'=>$post_list['nowPage']+1));?>" id="next" class="pure-button pager_child pager_p_n pure-button-primary">下一页</a>
            <?php endif; ?>
          </div>
          <?php endif; ?>
        </div>
