...
(function(){
  ...
  $(function(){
   ...
   var _id =$('#nid').find('input').val();
	function addPost(){
		var $postHtml = $('<div class="chooseShopDialog"><ul><center><img src="/php/weiphp3/Public/Home/images/loading.gif"/></center></ul><br/><div class="m15"><a href="javascript:;" class="btn" id="confirmBtn">确定</a></div></div>');
	  		...
	  		success:function(data){
	  			...
	  			if(list_data && list_data.length>0){
	  				...
	  				for(var i=0;i<list_data.length;i++){
	  					...
	  					//console.log(id)
	  					if(_id==id){
	  						html += '<li><input type="radio"  checked="checked" class="post_id" value="'+id+'"/><span class="title">'+title+'</span></li>';
	  					}else{
	  						html += '<li><input type="radio"   class="post_id" value="'+id+'"/><span class="title">'+title+'</span></li>';
	  					}
	  				}
	  				if(html!=""){
