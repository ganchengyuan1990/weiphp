...
<body id="scratch">
	<div class="container body">
    	<div style="text-align:center; padding:150px 0 50px;" >
    		<img src="/php/weiphp3/Public/Home/images/blank_pic.png" width="100"/>
            <br/>
            抱歉，<?php echo ($error); ?>
        </div>            
		<div class="btnWrap" style="text-align: center; padding:10px 0; width:80%; margin:0 auto;">
<a href="<?php echo addons_url('Coupon://Wap/personal');?>" class="start_btn">查看我的优惠券</a></div>
