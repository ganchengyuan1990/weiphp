...
<body>
<div class="container body" style="position:relative; background:#eee;">
	<div class="detail">
      <p class="title">优惠券介绍</p>
      <div class="content">
      	<?php echo ($info["use_tips"]); ?>
        <br/>
      </div>
      <p class="title">使用说明</p>
      <div class="content">
        <?php if(!empty($info['use_start_time']) && !empty($info['over_time'])): ?><p>· 有效期：<?php echo (time_format($info["use_start_time"])); ?>至<?php echo (time_format($info["over_time"])); ?></p><?php endif; ?>	
        <?php if($info[max_num]!=0): ?><p>· 每人限领取<?php echo ($info["max_num"]); ?>张</p><?php endif; ?>
      </div>
